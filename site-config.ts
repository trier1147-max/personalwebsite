export const siteConfig = {
  ...
  projects: [
    ...
    { id: 'proj5', image: '/images/project-working-agent.png', github: null, live: 'https://shrimpai.cc/workingagent/', liveLabel: '正式官网', imagePortrait: false, requiresProxy: false }, // 工作管家
